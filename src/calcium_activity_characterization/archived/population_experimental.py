...
from calcium_activity_characterization.analysis.metrics import Distribution, compute_histogram_func, compute_peak_frequency_over_time
...
def compute_population_metrics(self, bin_counts: int = 20, bin_width: int | None = 1, synchrony_window: int | None = 1) -> None:
    """
...
def plot_metadata_summary(self, save_path: Path | None = None) -> None:
    """
