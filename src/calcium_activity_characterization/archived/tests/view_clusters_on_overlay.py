...
from calcium_activity_characterization.io.images_loader import generate_distinct_colors
...
class ClusterOverlayViewer(QMainWindow):
    ...
    def load_folder(self):
        ...
        self.max_frame = max(p.fhw_end_time for c in self.cells for p in c.peaks)
    ...
    def build_frame_maps(self):
        ...
        for i, cluster in enumerate(self.clusters):
            ...
            for cell, peak_idx in cluster.members:
                ...
                for t in range(peak.fhw_start_time, peak.fhw_end_time + 1):
